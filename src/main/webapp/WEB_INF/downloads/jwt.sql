...
CREATE TABLE `user` (
  ...
  `lastpasswordresetdate` varchar(255) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'admin@admin.com','','admin','01-01-2016','admin','admin','admin'),(2,'enabled@user.com','','user','01-01-2016','user','user','user'),(3,'disabled@user.com','\0','user','01-01-2016','user','user','disabled');
...
-- Dump completed on 2017-09-07 19:45:44
